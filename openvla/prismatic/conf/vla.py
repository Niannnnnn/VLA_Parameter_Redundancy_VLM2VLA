...
@dataclass
class Exp_SigLIP_224px_LiberoSpatial(Exp_SigLIP_224px_Bridge):
    vla_id: str = "siglip-224px+mx-libero_spatial"
    base_vlm: Union[str, Path] = "siglip-224px+7b"  # 或你想微调的基模型
...
class VLARegistry(Enum):
    ...
    # === Libero Spatial Fine-tuning Configs ===
    SIGLIP_224PX_MX_LIBERO_SPATIAL = Exp_SigLIP_224px_LiberoSpatial
